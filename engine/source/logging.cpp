...
template Engine::String Engine::__get_banner<Engine::LOW>(String, Color, Color, Color);
template Engine::String Engine::__get_banner<Engine::MED>(String, Color, Color, Color);
template Engine::String Engine::__get_banner<Engine::HIG>(String, Color, Color, Color);

template Engine::String Engine::__get_highlight<Engine::LOW>(String, Color, Color);
template Engine::String Engine::__get_highlight<Engine::MED>(String, Color, Color);
template Engine::String Engine::__get_highlight<Engine::HIG>(String, Color, Color);
